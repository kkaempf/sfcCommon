...
/*
 * static void perform_on_list(Generic_list list, void (*fn) (void
 * *pointer, void *args),void *args); static void *first_that(Generic_list 
 * list, int (*fn) (const void *pointer, const void *args), const void
 * *args); static void *next_that(Generic_list list, int (*fn) (const void 
 * *pointer, const void *args), const void *args); static void
 * *previous_that(Generic_list list, int (*fn) (const void *pointer, const 
 * void *args), const void *args); static void *last_that(Generic_list
 * list, int (*fn) (const void *pointer, const void *args), const void
 * *args); static Generic_list all_such_that(Generic_list list, int (*fn)
 * (const void *pointer, const void *args), const void *args); static void 
 ...
 * 
 * if (list.info->lt) { if (!pointer) { mlogf(M_ERROR,M_SHOW, "%s: NULL
 * pointer passed\n", module); exit(EXIT_FAILURE); }
 * 
 * element = list.info->pre_element.next; while (element !=
 * &list.info->post_element && (*list.info->lt) (element->pointer,
 * pointer)) element = element->next;
 * 
 * new_element = NEW(Generic_list_element); new_element->next = element;
 * new_element->previous = element->previous; new_element->pointer =
 * pointer;
 * 
 * element->previous->next = new_element; element->previous = new_element;
 * 
 * list.info->num_of_elements++; } else add_to_end(list, pointer); } 
 */
/****************************************************************************/
...
/****************************************************************************/
/*
 * static void *peek_at_beginning(Generic_list list) { return
 * list.info->pre_element.next->pointer; } 
 */
/****************************************************************************/
/*
 * static void *peek_at_end(Generic_list list) { return
 * list.info->post_element.previous->pointer; } 
 */
/****************************************************************************/
...
/****************************************************************************/
/*
 * static void reset_to_end(Generic_list list) { list.info->current =
 * &list.info->post_element; } 
 */
/****************************************************************************/
...
/*
 * static void perform_on_list(Generic_list list, void (*fn) (void
 * *pointer, void *args), void *args) { Generic_list_element *element;
 * 
 * element = list.info->pre_element.next; while (element !=
 * &list.info->post_element) { (*fn) (element->pointer, args); element =
 * element->next; } } 
 */
/****************************************************************************/
/*
 * static void *first_that(Generic_list list, int (*fn) (const void
 * *pointer, const void *args), const void *args) { Generic_list_element
 * *element;
 * 
 * element = list.info->pre_element.next; while (element !=
 * &list.info->post_element && !(*fn) (element->pointer, args)) { element
 * = element->next; }
 * 
 * if (element->pointer) list.info->current = element;
 * 
 * return element->pointer; } 
 */
/****************************************************************************/
/*
 * static void *next_that(Generic_list list, int (*fn) (const void
 * *pointer, const void *args), const void *args) { Generic_list_element
 * *element;
 * 
 * element = list.info->current->next; while (element !=
 * &list.info->post_element && !(*fn) (element->pointer, args)) { element
 * = element->next; }
 * 
 * if (element->pointer) list.info->current = element;
...
/****************************************************************************/
/*
 * static void *previous_that(Generic_list list, int (*fn) (const void
 * *pointer, const void *args), const void *args) { Generic_list_element
 * *element;
 * 
 * element = list.info->current->previous; while (element !=
 * &list.info->pre_element && !(*fn) (element->pointer, args)) { element = 
 * element->previous; }
 * 
 * if (element->pointer) list.info->current = element;
 * 
...
/****************************************************************************/
/*
 * static void *last_that(Generic_list list, int (*fn) (const void
 * *pointer, const void *args), const void *args) { Generic_list_element
 * *element;
 * 
 * element = list.info->post_element.previous; while (element !=
 * &list.info->pre_element && !(*fn) (element->pointer, args)) { element = 
 * element->previous; }
 * 
 * if (element->pointer) list.info->current = element;
...
/****************************************************************************/
/*
 * static Generic_list all_such_that(Generic_list list, int (*fn) (const
 * void *pointer, const void *args), const void *args) { Generic_list
 * list_copy; Generic_list_element *element;
 * 
 * initialize_sorted_list(&list_copy, list.info->lt); element =
 * list.info->pre_element.next; while (element !=
 * &list.info->post_element) { if ((*fn) (element->pointer, args))
 * add_to_end(list_copy, element->pointer); element = element->next; }
 * 
 * return list_copy; } 
 */
/****************************************************************************/
/*
 * static void remove_all_such_that(Generic_list list, int (*fn) (const
 * void *pointer, const void *args), const void *args) { void *obj;
 * 
 * reset_to_beginning(list); while ((obj = next_in_list(list))) if ((*fn)
